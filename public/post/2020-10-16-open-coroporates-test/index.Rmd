...
In regards to the layout of this document. 
The major headings in the **top left** will allow you to nagivate the documents. 
The Analysis part of this document has been nested in  pages that can be accesed
via tabs. 

Please scroll down to the Analysis section, go through all tabs THEN scroll down to the 
bottom where you will find the conclusion. 


This will mean a little bit of scrolling up and down when reading through the Analysis section.


To **SHOW** all codes chunks please find code menu button on the top right and select
...
Due to issues ggplot2 the map was generated in another script saved and then inserted as an image
using the exact code found below. 
